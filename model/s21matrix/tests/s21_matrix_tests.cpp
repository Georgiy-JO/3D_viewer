...
TEST(createMatrix, test_1) {
    S21Matrix a(50, 50);
    a(45, 45) = 1.1112;
    EXPECT_EQ(1.1112, a(45, 45));
    EXPECT_EQ(0.0, a(49, 49));
}
...
TEST(CreateMatrix, EXCEPTION_1) {
    try {
        ...
        // check exception
        ASSERT_STREQ("Constructor S21Matrix(...) -> The size of the "
                     "\"matrix(this)\" is zero",
                     e.what());
    }
}
...
TEST(OperatorRoundBrackets, TestException_1) {
    ...
    try {
        ...
        ASSERT_STREQ("& operator()(...) -> Invalid index value (index < 0)",
                     e.what());
    }
}
...
TEST(OperatorRoundBrackets, TestException_2) {
    S21Matrix A(4, 4);
    S21Matrix const B(4, 4);
    S21Matrix R(4, 4);
    try {
        R(1, 2) += A(2, 4) * B(3, 4);
        FAIL();
    } catch (MatrixException &e) {
        ASSERT_STREQ("& operator()(...) -> Index exceeds matrix dimensions",
                     e.what());
    }
}
...
TEST(SumMatrix, TestException_1) {
    ...
    try {
        ...
        ASSERT_STREQ(
            "Error: SumMatrix(...) -> The size of the \"matrix(other)\" is zero",
            e.what());
    }
}
...
TEST(SumMatrix, TestException_2) {
    ...
    try {
        ...
        // check exception
        EXPECT_STREQ(
            "Error: SumMatrix(...) -> The size of the \"matrix(this)\" is zero",
            e.what());
    }
}
...
TEST(SumMatrix, TestException_3) {
    ...
    try {
        ...
        // check exception
        ASSERT_STREQ("Error: SumMatrix(...) -> The size of the matrices is zero",
                     e.what());
    }
}
...
TEST(SumMatrix, TestException_4) {
    ...
    try {
        ...
        // check exception
        ASSERT_STREQ("Error: SumMatrix(...) -> Different number of rows and "
                     "columns in \"this->matrix_\" and \"other.matrix\"",
                     e.what());
    }
}
...
TEST(SumMatrix, TestException_5) {
    ...
    try {
        ...
        // check exception
        ASSERT_STREQ("Error: SumMatrix(...) -> Different number of rows in "
                     "\"this->matrix_\" and \"other.matrix\"",
                     e.what());
    }
}
...
TEST(SubMatrix, TestException_1) {
    ...
    try {
        ...
        // check exception
        ASSERT_STREQ("Error: SubMatrix(...) -> Different number of rows and "
                     "columns in \"this->matrix_\" and \"other.matrix\"",
                     e.what());
    }
}
...
TEST(SubMatrix, TestException_2) {
    ...
    try {
        ...
        // check exception
        ASSERT_STREQ("Error: SubMatrix(...) -> Different number of rows in "
                     "\"this->matrix_\" and \"other.matrix\"",
                     e.what());
    }
}
...
TEST(SubMatrix, TestException_4) {
    ...
    try {
        ...
        // check exception
        ASSERT_STREQ("Error: SubMatrix(...) -> Different number of columns in "
                     "\"this->matrix_\" and \"other.matrix\"",
                     e.what());
    }
}
...
TEST(InverceMatrix, test_2) {
    ...
    result = A.InverseMatrix();
    ASSERT_TRUE(result == B);
    ASSERT_TRUE(result.IsContinuous());
}
...
TEST(MulNumber, EXCEPTION_1) {
    ...
    try {
        ...
        // check exception
        ASSERT_STREQ("Error: MulNumber(...) -> The size of the \"matrix(this)\" is "
                     "zero",
                     e.what());
    }
}
...
TEST(SetCols, test_2_zero_cols) {
    ...
    A.SetCols(8);
    EXPECT_EQ(0, A.GetCols());
    ASSERT_TRUE(!A.IsContinuous());
}

TEST(MultMatrix, test_1_correct) {
    S21Matrix A(1, 4);
    S21Matrix B(4, 4);
    S21Matrix Result(1, 4);
...
//     try {
//     S21Matrix A(2000000000,20000000);
//     S21Matrix B(200000000,20000000);
//     S21Matrix result(2000000,20000000);
//     FAIL();
