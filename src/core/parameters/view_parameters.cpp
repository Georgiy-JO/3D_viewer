...
bool ViewParameters::ReadFromSettingsFile(const std::string& file_name) {
  SetDefaults();
  if (!s21::service::file::IsFileOk(file_name, kMaxSettingsFileSize)) return false;
...
void ViewParameters::SaveToSettingsFile() const {
  ...
  ofs <<m_background_color.kTag << ' '<< m_background_color.GetValue().x << ' '<< m_background_color.GetValue().y << ' '<< m_background_color.GetValue().z << ' '<< m_background_color.GetValue().w << '\n';
  ofs <<m_model_color.kTag << ' '<< m_model_color.GetValue().x << ' '<< m_model_color.GetValue().y << ' ' << m_model_color.GetValue().z << ' '<< m_model_color.GetValue().w << '\n';
  ofs << m_projection_kind.kTag<< ' '<< static_cast<int>(m_projection_kind.GetValue()) << '\n';
...
// s21::vectors::Vec4 ViewParameters::GetBackgroundColor() const{
//     return m_background_color;
// }
// s21::vectors::Vec4 ViewParameters::GetModelColor() const{
//     return m_model_color;
// }
// s21::ViewParameters::ProjectionKind ViewParameters::GetProjectionKind()
// const{
//     return m_projection_kind;
// }
// double ViewParameters::GetVertexSize() const{
//     return m_vertex_size;
// }
// s21::ViewParameters::VertexKind ViewParameters::GetVertexKind() const{
//     return m_vertex_kind;
// }
// double ViewParameters::GetEdgeWidth() const{return m_edge_width;}
// s21::ViewParameters::EdgeKind ViewParameters::GetEdgeKind() const{return
// m_edge_kind;}

// void ViewParameters::SetBackgroundColor(const s21::vectors::Vec4& input){
// m_background_color=input;} void ViewParameters::SetModelColor(const
// s21::vectors::Vec4& input){    m_model_color=input;} void
// ViewParameters::SetProjectionKind(const s21::ViewParameters::ProjectionKind&
// input){   m_projection_kind=input;} void ViewParameters::SetVertexSize(const
// double& input){    m_vertex_size=input;} void
// ViewParameters::SetVertexKind(const s21::ViewParameters::VertexKind& input){
// m_vertex_kind=input;} void ViewParameters::SetEdgeWidth(const double& input
// ){    m_edge_width=input;} void ViewParameters::SetEdgeKind(const
// s21::ViewParameters::EdgeKind& input ){    m_edge_kind=input;}
