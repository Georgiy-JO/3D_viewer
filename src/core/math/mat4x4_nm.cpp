...
double Degrees(double radians) { return radians * kRadToDeg; }
...
Mat4::Mat4() : m_mat4x4(4, 4) { IdentityMatrix(); }

double Mat4::operator()(int row, int col) const { return m_mat4x4(row, col); }

double& Mat4::operator()(int row, int col) { return m_mat4x4(row, col); }

Mat4 Mat4::operator*(const Mat4& other) { return Mat4(m_mat4x4 * other.m_mat4x4); }

Mat4 Mat4::operator+(const Mat4& other) const { return Mat4(m_mat4x4 + other.m_mat4x4); }
