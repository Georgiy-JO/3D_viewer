...
class Parser {
    ...
    bool ProcessCharF(std::istringstream& iss, std::vector<double>& vertices,int& next_symbol);
    bool ProcessCharLP(std::istringstream& iss, std::vector<double>& vertices,int& next_symbol);
