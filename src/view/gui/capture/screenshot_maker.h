...
class ScreenshotMaker : public Capturer<ScreenshotMaker>{
  ...
  public:
     ...
     * It includes capture location and looks following way: "captures/screenshot".
     * That may cause issues in case porting the program to windows.
     */
    ...
    /**
     * @return Returns false if the screenshot was not saved.
     * @attention Uses the file_name that was set before (set it before using this function).
     */
