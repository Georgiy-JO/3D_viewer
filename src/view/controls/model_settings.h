...
namespace s21::gui::controls {
    class ModelSettings {
     public:
        void InitializeSliders(QSlider* edge_, std::pair<double,double> edge_range, double edge_value,
                            QSlider* vertex_, std::pair<double,double> vertex_range, double vertex_value);
        void InitializeComboBoxes(QComboBox * projection_cbox_, const int projection_cbox_value, 
     ...
     private:
         ...
         */
        static constexpr const char* kProjectionKind_0 ="Central Projection";
        static constexpr const char* kProjectionKind_1 ="Orthographic Projection";
