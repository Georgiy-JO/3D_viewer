...
void ModelSettings::InitializeSliders(QSlider* edge_,
                                      ...
                                      double vertex_value) {
  Slider sl_temp;
  sl_temp.Reset(edge_, edge_range, edge_value,
                (edge_range.second - edge_range.first) / kStepsPerSlide);
  sl_temp.Reset(vertex_, vertex_range, vertex_value,
                (vertex_range.second - vertex_range.first) / kStepsPerSlide);
}
void ModelSettings::InitializeComboBoxes(QComboBox* projection_cbox_,
                                         const int projection_cbox_value,
                                         QComboBox* edge_cbox_,
                                         const int edge_cbox_value,
