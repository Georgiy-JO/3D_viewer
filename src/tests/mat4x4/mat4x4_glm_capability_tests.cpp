...
TEST(Mat4Test, Translation) {
    Mat4 mat = Mat4::Identity();
    vectors::Vec3 translation{1.0, 2.0, 3.0};
...
TEST(Mat4Test, Scale) {
    Mat4 mat = Mat4::Identity();
    vectors::Vec3 scale{2.0, 3.0, 4.0};
...
TEST(Mat4Test, CombinedTransformations) {
    Mat4 mat = Mat4::Identity();
    vectors::Vec3 trans{1.0, 2.0, 3.0};
    vectors::Vec3 scale{2.0, 3.0, 4.0};
    double angle = Radians(45.0);
    vectors::Vec3 axis{1.0, 1.0, 0.0};
