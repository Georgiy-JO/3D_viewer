...
TEST(Core_parameters, View_Parameters_1) {
    ...
    EXPECT_EQ(prs.GetProjectionKind(),s21::parameters::ViewParameters::ProjectionKind::kCentral);
    EXPECT_EQ(prs.GetProjectionKindRange().min,0);
    EXPECT_EQ(prs.GetProjectionKindRange().max,1);

    EXPECT_EQ(prs.GetVertexKind(),s21::parameters::ViewParameters::VertexKind::kSquare);
    EXPECT_EQ(prs.GetVertexKindRange().min,0);
    EXPECT_EQ(prs.GetVertexKindRange().max,2);

    EXPECT_EQ(prs.GetEdgeKind(),s21::parameters::ViewParameters::EdgeKind::kSolid);
    ...
    EXPECT_DOUBLE_EQ(prs.GetVertexSizeRange().max,10);

    EXPECT_DOUBLE_EQ(prs.GetEdgeWidth(),1);
    EXPECT_DOUBLE_EQ(prs.GetEdgeWidthRange().min,1);
    EXPECT_DOUBLE_EQ(prs.GetEdgeWidthRange().max,10);
...
TEST(Core_parameters, View_Parameters_2) {
    ...
    prs.SetProjectionKind(s21::parameters::ViewParameters::ProjectionKind::kCentral);
    prs.SetVertexSize(5);
    ...
    EXPECT_EQ(prs.GetVertexKind(),s21::parameters::ViewParameters::VertexKind::kNone);
    EXPECT_EQ(prs.GetVertexKindRange().min,0);
    EXPECT_EQ(prs.GetVertexKindRange().max,2);

    EXPECT_EQ(prs.GetEdgeKind(),s21::parameters::ViewParameters::EdgeKind::kNone);
    EXPECT_EQ(prs.GetEdgeKindRange().min,0);
    EXPECT_EQ(prs.GetEdgeKindRange().max,2);
...
TEST(Core_parameters, View_Parameters_4) {
    ...
    EXPECT_EQ (prs.SetVertexSize(15),false);
