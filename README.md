...
|| Сборка программы настроена с помощью Cmake/Makefile, присутствует стандартный набором целей для GNU-программ (установка может вестись в любой другой произвольный каталог): <br>    -all, <br>    -install, <br>    -uninstall, <br>    -clean, <br>    -dvi, <br>    -dist, <br>    -tests.|
